...
var minimumDeviation = function(nums) {
  ...
  let minVal = maxOdd;
  // iterate through the array
    // while the 2 * value is less than the maxOdd
      // reassign to 2 * value 
    // reassign minVal if needed
  nums.forEach((num, i) => {
    if (num % 2 === 1) {
      while (num * 2 < maxOdd) {
        num = num * 2;
  ...
  return maxOdd - minVal;

};

console.log(minimumDeviation([4,1,5,20,3]));  //  => [4, 1, 5, 20, 3] => 4 